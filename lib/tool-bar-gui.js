...
import view, { EditView, RemoveView, open } from './views'
...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'tool-bar-gui:open-edit-view': () => open('edit', {
        main: this,
        toolbar,
        create: bn => {
          this.addButton(bn)
  ...
  consumeToolBar(getToolbar) {
    ...
    views = {
      ...
      remove: view(RemoveView, {
        ...
        toolbar,
        open: id => {
          let { tooltip, cmd: text, icon, iconset } = items.find(btn =>btn.tooltip === id)
          views.edit.updateState({
            text,
            tooltip,
            icon,
            iconset,
